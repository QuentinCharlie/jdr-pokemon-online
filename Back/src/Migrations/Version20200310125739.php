 ...
 */
final class Version20200310125739 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inventory (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trainer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, age INT NOT NULL, vitality INT NOT NULL, strength INT NOT NULL, endurance INT NOT NULL, concentration INT NOT NULL, wildpower INT NOT NULL, dexterity INT NOT NULL, do_it_yourself INT DEFAULT NULL, charisma INT DEFAULT NULL, fighting INT DEFAULT NULL, driving INT DEFAULT NULL, detection INT DEFAULT NULL, furtivity INT DEFAULT NULL, expression INT DEFAULT NULL, phychology INT DEFAULT NULL, sport INT DEFAULT NULL, survival INT DEFAULT NULL, education INT DEFAULT NULL, geography INT DEFAULT NULL, computer_science INT DEFAULT NULL, legend INT DEFAULT NULL, medicine INT DEFAULT NULL, pkmn_medicine INT DEFAULT NULL, nature INT DEFAULT NULL, phyche INT DEFAULT NULL, science INT DEFAULT NULL, pokelogy INT DEFAULT NULL, avatar VARCHAR(255) NOT NULL, background LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
