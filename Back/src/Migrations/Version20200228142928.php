 ...
 */
final class Version20200228142928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE avatar (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, avatar_profil VARCHAR(255) NOT NULL, avatar_game VARCHAR(255) NOT NULL, INDEX IDX_1677722F67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE attack (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, energy INT NOT NULL, category VARCHAR(255) NOT NULL, distance VARCHAR(255) NOT NULL, accuracy INT NOT NULL, damage INT NOT NULL, effect VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_attack (type_id INT NOT NULL, attack_id INT NOT NULL, INDEX IDX_64174603C54C8C93 (type_id), INDEX IDX_64174603F5315759 (attack_id), PRIMARY KEY(type_id, attack_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_attack DROP FOREIGN KEY FK_64174603F5315759');
        $this->addSql('ALTER TABLE type_pokemon DROP FOREIGN KEY FK_4AFDFF06C54C8C93');
        $this->addSql('ALTER TABLE type_attack DROP FOREIGN KEY FK_64174603C54C8C93');
